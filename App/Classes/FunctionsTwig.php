...
class FunctionsTwig {
    ...
    private function siteUrl(){
        ...
        $this->functions['site_url'] = new \Twig\TwigFunction('site_url', function(){
    ...
    private function categorias(){
        ...
        $this->functions['categorias'] = new \Twig\TwigFunction('categorias', function(){
    ...
    private function marcas(){
        ...
        $this->functions['marcas'] = new \Twig\TwigFunction('marcas', function(){
    ...
    private function novidade(){
        ...
        $this->functions['novidade'] = new \Twig\TwigFunction('novidade', function(){
    ...
    private function promocao(){
        ...
        $this->functions['promocao'] = new \Twig\TwigFunction('promocao', function(){
    ...
    private function breadCrumb(){
        ...
        // Bread crumb
        $this->functions['breadCrumb'] = new \Twig\TwigFunction('breadCrumb', function(){
    ...
    private function valorProdutosCarrinho(){
        ...
        $this->functions['valorProdutosCarrinho'] = new \Twig\TwigFunction('valorProdutosCarrinho', function(){
    ...
    private function numeroProdutosCarrinho(){
        ...
        $this->functions['numeroProdutosCarrinho'] = new \Twig\TwigFunction('numeroProdutosCarrinho', function(){
    ...
    //     $this->functions['dadosFrete'] = new \Twig\TwigFunction('dadosFrete', function(){
    //     	return new Frete;
    //     });
    //
    //     return $this;
    ...
    private function totalComFrete(){
        ...
        $this->functions['totalComFrete'] = new \Twig\TwigFunction('totalComFrete', function(){
    ...
    private function logado(){
        ...
        $this->functions['logado'] = new \Twig\TwigFunction('logado', function(){
    ...
    private function user(){
        ...
        $this->functions['user'] = new \Twig\TwigFunction('user', function(){
    ...
    private function errorField(){
        ...
        $this->functions['errorField'] = new \Twig\TwigFunction('errorField', function($field){
    ...
    private function persist(){
        ...
        $this->functions['persist'] = new \Twig\TwigFunction('persist', function($field){
    ...
    private function flash(){
        ...
        $this->functions['flash'] = new \Twig\TwigFunction('flash', function($index){
    ...
    private function estoque(){
        ...
        $this->functions['estoque'] = new \Twig\TwigFunction('estoque', function($id){
    ...
    private function cliquesProduto(){
        ...
        $this->functions['cliquesProduto'] = new \Twig\TwigFunction('cliquesProduto', function($slug) use($cache){
    ...
    private function statusPagamento(){
        ...
        // Estoque dos produtos
        $this->functions['statusPagamento'] = new \Twig\TwigFunction('statusPagamento', function($status){
    ...
    private function statusPedido(){
        ...
        $this->functions['statusPedido'] = new \Twig\TwigFunction('statusPedido', function($status){
